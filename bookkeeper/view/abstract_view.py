...
class AbstractView(Protocol):
    ...
    def set_category_add_handler(self, cat_add_handler: Callable[[str, str | None], None]) -> None:
        pass
    ...
    def set_expense_modify_handler(self, exp_modify_handler: Callable[[int, str, str], None]) -> None:
        pass
